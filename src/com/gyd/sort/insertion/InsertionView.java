 ...
 */
public class InsertionView extends AlgorithmFrame {


    public InsertionView(String title, int canvasWidth, int canvasHeight) {
    ...
    // 渲染
    public void render(InsertionData data) {
        this.data = data;
        // 重新绘制画布
        repaint();
    }
